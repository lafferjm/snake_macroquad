...
impl GameOverScreen{
    ...
    pub fn draw(&self) {
        draw_text_ex("Game Over", self.main_position.x as f32, self.main_position.y as f32, TextParams {
            font_size: 128,
            font: Some(&self.font),
            ..Default::default()
        });

        draw_text_ex("Press <space> to start over!", self.secondary_position.x as f32, self.secondary_position.y as f32, TextParams {
            font_size: 32,
            font: Some(&self.font),
            ..Default::default()
        })
